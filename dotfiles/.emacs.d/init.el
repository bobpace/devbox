...
(custom-set-variables
 ...
 '(omnisharp-server-executable-path "~/data/omnisharp-server/OmniSharp/bin/Debug/OmniSharp.exe")
 '(package-selected-packages
   (quote
    (window-numbering web-mode smartparens react-snippets powerline-evil powerline omnisharp mocha-snippets markdown-mode magit less-css-mode json-mode js2-mode js-doc iedit helm-ls-git helm-swoop helm-flycheck helm-ag golden-ratio go-mode fsharp-mode use-package helm-projectile flycheck expand-region evil-visualstar evil-surround evil-nerd-commenter evil-matchit evil-leader emmet-mode dockerfile-mode company-quickhelp ag ace-jump-mode))))
(custom-set-faces
